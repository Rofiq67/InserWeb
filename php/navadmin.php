    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white" >
        ...
        <a class="navbar-brand" href="#" style="font-weight: 700; font-style: normal; font-size:20pt; line-height:33px; ">
            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link active" aria-current="page" href="haladmin.php">Home</a>
                </li>
                <li class="nav-item" style="margin-right: 32px;">
                <a class="nav-link" href="tabeladmin.php">Cek Service</a>
                </li>
                <li class="nav-item" style="margin-right: 32px;">
                <a class="nav-link" href="abadmin.php">About me</a>
                </li>
                </li>
