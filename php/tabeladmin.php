...
<div class="container mt-4" id="judul">
    ...
    <hr>
        <div style="text-align: right">
            <button type="button" class="btn btn-primary" ><i class='bx bx-plus-medical' ></i>Tambah</button>
        </div>
        <br>
    <div class="col-md-3">
      </div>
        <table id="example" class="table table-striped table-bordered" style="text-align: center;">
            ...
            <tbody> 
                <tr>
                    ...
                    <td><img src="img/3.jpg" class="rounded mx-auto d-block" alt="..."></td>
                ...
                <th scope="row" style="text-align: center;">2</th>
                    ...
                    <td>08972737328</td>
                    <td>Tokyo, Rt02 03</td>
                    <td><img src="img/2.jpg" class="rounded mx-auto d-block" alt="..."></td>
                    <td><button type="button" class="btn btn-outline-success" style="text-align: center;" >Success</button></td>
                    <td><button type="button" class="btn btn-warning"><i class='bx bx-edit-alt'></i></button>
                        <button type="button" class="btn btn-danger"> <i class='bx bx-trash-alt'></i></button>
                    </td>
                ...
                <th scope="row" style="text-align: center;">3</th>
                    ...
                    <td>08376662367</td>
                    <td>San Francisco</td>
                    <td><img src="img/1.jpg" class="rounded mx-auto d-block" alt="..."></td>
