        ...
        <a class="navbar-brand" href="#" style="font-weight: 700; font-style: normal; font-size:20pt; line-height:33px; ">
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink" >
                    <li><a class="dropdown-item" href="#"style="font-color:black;"><b>Profil</b></a></li>
                    <li><a class="dropdown-item" href="Loginpage.php"><i class='bx bx-log-out'></i> <b>Log Out</b></a></li>
                </li>
            </ul>
            </div>
        </div>
